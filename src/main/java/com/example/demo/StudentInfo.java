...
//constructor
    ...
    public StudentInfo() {
        ...
        //create JList
        courseJList = new JList<>(new DefaultListModel<>());

        //create combo box
        courseJCombo = new JComboBox<String>();
        courseJCombo.addItem(" ");
        ...
        courseJCombo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Object selectedCourseObj = courseJCombo.getSelectedItem();
                if (selectedCourseObj != null) {
                    String courseSelected = selectedCourseObj.toString();
                ...
                new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (textArea != null) {
                            ...
                            textArea = new JTextArea(5, 50);
                            textArea.setEditable(false);
                            textArea.setText("Information will be displayed here.");
    ...
    public class RadioButtonHandler implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (Objects.equals(radioButton.getText(), "Computer Science")) {
                if (courseJCombo.getItemCount() > 0) {
            ...
            else if (Objects.equals(radioButton.getText(), "Business")) {
                if (courseJCombo.getItemCount() > 0) {
                    courseJCombo.removeAllItems();
                }
